...
function renderProfileEditForm(opts: ProfileEditOpts): string {
  ...
  tpl.assignVars({
    ...
    L_CONFIRM_PASSWORD_EXPLAIN: "Required to confirm changes",
    CUR_PASSWORD: "",
    L_NEW_PASSWORD: "New password:",
    L_PASSWORD_IF_CHANGED: "Only fill in if you want to change it",
    NEW_PASSWORD: "",
    L_CONFIRM_PASSWORD: "Confirm password:",
    L_PASSWORD_CONFIRM_IF_CHANGED: "Only confirm if you changed it above",
    PASSWORD_CONFIRM: "",
    ...
    L_SIGNATURE_EXPLAIN: "This is appended to your posts.",
    ...
    L_NOTIFY_ON_REPLY_EXPLAIN: "Send e-mail when someone replies to a topic you posted in.",
    ...
    NOTIFY_PM_NO: "",
    L_POPUP_ON_PRIVMSG: "Pop up window on new PM:",
    L_POPUP_ON_PRIVMSG_EXPLAIN: "Some templates use this.",
    POPUP_PM_YES: "",
    POPUP_PM_NO: 'checked="checked"',
    L_ALWAYS_ADD_SIGNATURE: "Always attach signature:",
    ...
    L_DATE_FORMAT_EXPLAIN: "The syntax used is identical to PHP date().",
    DATE_FORMAT: profileData.user_dateformat ?? "DD Mon YYYY HH24:MI",

    // Avatar
    L_AVATAR_PANEL: "Avatar",
    L_AVATAR_EXPLAIN:
      "Upload an image to use as your avatar. Max 80x80 pixels.",
